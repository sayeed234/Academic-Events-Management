...
(function (root, factory) {
	...
	// The keyboard control system-views.
...
*/
		...
		currentTime: function() { // Handles clicks on the text
			// Added to avoid errors using cssSelector system-views for the text
		},
		duration: function() { // Handles clicks on the text
			// Added to avoid errors using cssSelector system-views for the text
		},
		gui: function() { // Handles clicks on the gui
			// Added to avoid errors using cssSelector system-views for the gui
		},
		noSolution: function() { // Handles clicks on the error message
			// Added to avoid errors using cssSelector system-views for no-solution
		},
