		...
		init : function(ed, url) {
			...
			ed.addCommand('mceElvtImage', function() {
				ed.windowManager.open({
					file : url + '/index.blade.php?d='+encodeURI(tinyMCE.activeEditor.getParam('open_manager_upload_path')),
					//file : url + '/dialog.htm',
...
function openmanager(field_name, url, type, win) {    
    ...
    var strUploaderURL = strPluginPath + "/index.blade.php";												// generate the path to the uploader script
