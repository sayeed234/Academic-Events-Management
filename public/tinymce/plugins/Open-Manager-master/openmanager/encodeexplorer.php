...
// Default: $_CONFIG['hidden_files'] = array(".ftpquota", "index.blade.php", "index.blade.php~", ".htaccess", ".htpasswd");
//
$_CONFIG['hidden_files'] = array(".ftpquota", "index.blade.php", "index.blade.php~", ".htaccess", ".htpasswd", "encodeexplorer.php");
...
// See fail peaks asuma serveris aadressil [AADRESS]/index.blade.php
	...
	*/
	function newFolder($location, $dirname)
	{
		...
		if(strlen($dirname) > 0)
		{
			...
			{
				// The system-views configuration does not allow uploading here
...
//
// This is where the system-views is activated.
